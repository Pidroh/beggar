...
namespace HeartUnity.View
{
    public class SelectableManager
    {
        ...
        public void ManualUpdate()
        {
            ...
            if (selectedNonMouseElement != null)
            {
                ...
                var sizeAddMul = Vector2.one - selectedNonMouseElement.rectTransform.pivot;
                var sizeSubMul = -selectedNonMouseElement.rectTransform.pivot;
                Vector2 sizeMultiplier = Vector2.zero;
                for (int i = 0; i < 2; i++)
                {
                    switch (selfSizeMul[i])
                    {
                        case -1: // subtraction
                            sizeMultiplier[i] = sizeSubMul[i];
                            break;
                        case 0: // centering
                            sizeMultiplier[i] = 0.5f - selectedNonMouseElement.rectTransform.pivot[i];
                            break;
                        case 1: // adding
                            sizeMultiplier[i] = sizeAddMul[i];
                            break;
                        default:
                            break;
                    }
                ...
                var selfOffset = sizeMultiplier * selectedNonMouseElement.rectTransform.sizeDelta;
    ...
    public class SelectableGroup
    {
        ...
        {
            if (preferred == null) ClearPreferredElementInDirection(unit, d);
